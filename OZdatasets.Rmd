...
df<-rbind(c("ozflights", "transport", "package", "Flight data"),
          ...
          c("smokeybear", "OzUncon19", "package", "Air quality datasets"), # TO ADD
          c("learningtower", "OzUncon19", "package", "PISA data "), # TO ADD
...
OzUnconf19 developed a package on the air quality in NSW - daily average AQI in NSW from 2014-2019. 
```{r, eval=FALSE}
