...
Various datasets about Austrlian birds are [here](https://birdata.birdlife.org.au/). Simply 
...
The r package *bomrang* [here](https://cran.r-project.org/web/packages/bomrang/bomrang.pdf) has functions that extracts Australian Government Bureau
